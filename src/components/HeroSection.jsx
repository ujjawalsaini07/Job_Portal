  ...
  return (
    <section className="w-full flex flex-col items-center justify-center text-center px-4 pt-25 bg-gray-50">
      ...
      <div className="mt-8 flex flex-col sm:flex-row gap-4">
        <button className="px-12 py-4 border-2 text-xl border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-700 hover:text-white transition">
          Find Jobs
        </button>
        <button className="px-12 py-4 border-2 text-xl border-blue-600 text-blue-600 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition">
          Find Talent
        </button>
      </div>
      <SearchBar/>
